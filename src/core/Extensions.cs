...
namespace GameOfLife.Linq
{
    public static class Extensions
    {
        public static bool TryGetAt<T>(this T[,] array, Graphics2D.Location location, out T value)
        {
        ...
        public static void ForXYAt<T>(this T[,] array, Graphics2D.Location location, int width, int height, Action<(int x,int y, int arrayX, int arrayY)> action)
        {
            if (array == null) throw new ArgumentNullException(nameof(array));
